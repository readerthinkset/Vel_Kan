"""
Velocity Kannada - Unified Social Media Upload Script
...
def get_latest_reel():
    ...
    return {
        ...
        "metadata": metadata,
        "category": metadata.get("category_english", "Kannada Learning"),
...
def generate_caption(phrases, category, platform="facebook"):
    ...
    if platform == "facebook":
        ...
        for i, phrase in enumerate(phrases[:5], 0):
            ...
            caption_lines.append(f"   {phrase.get('kannada', '')}")
            caption_lines.append(f"   [{phrase.get('transliteration', phrase.get('romaji', ''))}]")
        ...
        caption_lines.extend([
            ...
            f"Follow for daily Kannada lessons!",
            f"",
...
def upload_to_all_platforms(video_path, caption, category, phrases=None):
    ...
    print("\n" + "="*80)
    print("VELOCITY KANNADA - MULTI-PLATFORM UPLOAD")
    print("="*80)
...
def main():
    ...
    print("\n" + "="*80)
    print("VELOCITY KANNADA - AUTOMATED UPLOAD")
    print("="*80)
